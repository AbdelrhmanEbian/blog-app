...
const Featured = ({ post }: { post: post | null }) => {
  return (
    <div>
      ...
      <div className='text-[60px] min-h-[300px] md:flex my-[70px] items-center gap-8'>
        <div className="h-full   w-1/2 flex-col items-center justify-between  max-md:w-full flex-1 relative">
            <Image
